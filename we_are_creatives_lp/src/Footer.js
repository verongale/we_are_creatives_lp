function Footer(){
    return (
      <>
        <div className="bg-green-300 h-[32rem] flex flex-col justify-center items-center">
          <div>
            <p className="py-10 text-emerald-700 font-extrabold text-4xl">
              sunnyside
            </p>
          </div>
          <div>
            <ul className="py-6 flex space-x-4 text-emerald-700 text-2xl ">
              <li className="cursor-pointer py-2 px-4">About</li>
              <li className="cursor-pointer py-2 px-4">Services</li>
              <li className="cursor-pointer py-2 px-4">Projects</li>
            </ul>
          </div>
